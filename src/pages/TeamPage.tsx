  ...
  return (
    <div className="bg-[#faf9f6] min-h-screen pt-24 pb-28">
      ...
      <header className="max-w-4xl mx-auto text-center px-4 sm:px-6 mb-16 sm:mb-24">
        ...
        >
          THE ARTISANS OF DELANEY HAIR STYLIST
        </h1>
        ...
        <p className="text-sm sm:text-base text-[#555555] font-light leading-relaxed max-w-2xl mx-auto">
          Every stylist at Delaney Hair Stylist has been hand-selected for their passion for healthy hair, continuous master-level education, and warm, attentive chair-side care.
        </p>
      </header>
